  ...
  return (
    <main className="flex min-h-screen flex-col p-4">
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-[#fbba72]/25 px-6 py-10">
          ...
          <Link
            href="/quiz"
            className="flex items-center gap-5 self-start rounded-lg bg-[#8f250c] px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-[#ca5310] md:text-base"
          >
